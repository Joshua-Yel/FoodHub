...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setFormData({ ...formData, successMessage: 'Message sent successfully!', isSubmitting: false });
      } else {
        setFormData({ ...formData, errorMessage: 'Error submitting message. Please try again later.', isSubmitting: false });
      }
    } catch (error) {
